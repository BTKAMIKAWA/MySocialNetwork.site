...
<body>
    ...
    * {
	...
	<form action="comment_frame.php?post_id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="POST">
		...
		<input class="btn btn-warning" type="submit" name="postComment<?php echo $post_id; ?>" value="Post">
	</form>
    ...
    if($count != 0) {
        while($comment = mysqli_fetch_array($get_comments)) {
            ...
            <div class="comment_section"> 
                <a href="<?php echo $posted_by?>" target="_parent"><img src="<?php echo $user_obj->getProfilePic(); ?>" title="<?php echo $posted_by; ?>" style="float:left; height:35; width:35"></a>
        ...
        echo "<center><br>No Comments!</center>";
    }
    ?>
