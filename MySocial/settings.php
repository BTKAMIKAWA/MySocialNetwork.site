...
<div class="main-column column">
	...
	<form action="settings.php" method="POST">
		...
		<input type="submit" name="update_details" id="save_details" value="Update Details" class="btn btn-warning info settings_submit"><br>
	</form>
	...
	<form action="settings.php" method="POST">
		...
		<input type="submit" name="update_password" id="save_details" value="Update Password" class="btn btn-warning info settings_submit"><br>
	</form>

	<h4>Close Account</h4>
	<form action="settings.php" method="POST">
		<input type="submit" name="close_account" id="close_account" value="Close Account" class="btn btn-danger settings_submit">
	</form>
